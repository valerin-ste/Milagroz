...
<div class="d-flex justify-content-between align-items-center mt-3 mb-2 px-2">
    <div>
        <h2 class="fw-bold mb-1" style="color: var(--text-main); font-size: 1.75rem;">Registrar Dotación</h2>
        <p class="text-muted mb-0">Gestione la entrega de dotación y equipos al personal.</p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm" style="border-radius: 20px;">
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('admin.dotaciones.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4 position-relative text-start">
                        <label class="form-label fw-bold small text-uppercase" style="color: #64748b; letter-spacing: 0.5px;">
                            Empleado Beneficiario <span class="text-danger">*</span>
                        </label>
                    ...
                    <div class="mb-4 text-start">
                        ...
                        <textarea name="observaciones" rows="3" 
                                  ...
                                  placeholder="Detalle el estado de la entrega o especificaciones adicionales..."
                    ...
                    <div class="mb-4 text-start">
                        <label class="form-label fw-bold small text-uppercase" style="color: #64748b; letter-spacing: 0.5px;">
                            Soporte / Acta de Entrega (PDF, JPG, PNG)
                        </label>
            ...
            item.innerHTML = `
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="text-muted">${emp.persona.numero_documento} | ${emp.cargo}</small>
                    </div>
                </div>
            `;
