            ...
            <div class="card-body p-5">
                <form action="{{ route('admin.formaciones.update', $formacion->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-5">
                        <a href="{{ route('admin.formaciones.index') }}"
                        class="btn btn-light border py-3 px-4 fw-bold shadow-sm rounded">
                            <i class="fas fa-times me-2"></i> CANCELAR
                        </a>

                        <button type="submit"
                                class="btn btn-orange text-white py-3 px-4 fw-bold shadow-sm ripple"
