...
<div class="d-flex justify-content-between align-items-center mt-3 mb-2 px-2">
    <div>
        ...
        <p class="text-muted mb-0" style="font-size: 0.95rem;">Defina el nombre y permisos del nuevo rol.</p>
    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="name"
                                       ...
                                       placeholder="Ej: Editor, RH, Supervisor" required>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row g-2">
                                    @forelse($permissions as $permission)
                                        <div class="col-md-4">
                                            <div class="role-check-card {{ in_array($permission->name, old('permissions', [])) ? 'selected' : '' }}">
