...
@section('title', 'Nueva Capacidad Instalada')

@section('content_header')
<div class="d-flex justify-content-between align-items-center mt-3 mb-2 px-2">
    <div>
        <h2 class="fw-bold mb-1" style="color: var(--text-main); font-size: 1.75rem;">Registrar Capacidad Instalada</h2>
        <p class="text-muted mb-0">Gestione la capacidad instalada y utilizada por el personal.</p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm" style="border-radius: 20px;">
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('admin.capacidad_instalada.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6 text-start">
                            ...
                            <input type="number" name="capacidad_disponible" 
                                   ...
                                   placeholder="0"
                                   min="0"
                                   value="{{ old('capacidad_disponible') }}" 
                                   style="border-radius: 12px; height: 50px;">
