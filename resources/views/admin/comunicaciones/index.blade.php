...
<div class="container-fluid px-2">
    ...
    <form method="GET" action="{{ route('admin.comunicaciones.index') }}" class="mb-4">
        <div class="card shadow-sm border-0 rounded-4" style="background-color: #f8fafc;">
            <div class="card-body p-3">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-5">
                        <label class="text-muted small fw-bold mb-2 ps-1">Buscar Empleado / Destinatario</label>
                    ...
                    {{-- CAMPO: DOCUMENTO --}}
                    <div class="col-md-4">
                        <label class="text-muted small fw-bold mb-2 ps-1">Número de Documento</label>
                        <div class="d-flex align-items-center bg-white" style="border-radius: 30px; height: 45px; padding: 0 15px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); border: 1px solid #e2e8f0;">
                            <i class="fas fa-id-card text-muted" style="font-size: 14px;"></i>
                            <input type="text" name="documento" class="form-control border-0 shadow-none w-100 bg-transparent ms-2 px-0"
                                   placeholder="Documento..." value="{{ request('documento') }}" style="outline: none;">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.comunicaciones.index') }}" class="btn bg-white border flex-grow-1 fw-bold text-secondary d-flex justify-content-center align-items-center" style="border-radius: 30px; height: 45px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead style="background-color: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                        <tr>
                            ...
                            <th class="py-3 text-muted" style="font-weight: 600; font-size: 0.85rem; text-transform: uppercase;">Asunto</th>
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9;">
                            ...
                            <td class="py-3">
                                <span class="d-block" style="color: #334155; font-weight: 500;">
                                    <i class="fas fa-envelope text-muted me-1"></i> {{ $c->asunto }}
                                </span>
                            </td>
                            ...
                            <td colspan="5" class="text-center py-5 text-muted">
                                <div class="d-flex flex-column align-items-center">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px; background-color: rgba(19,182,236,0.1);">
                                        <i class="fas fa-bullhorn fa-2x" style="color: var(--primary-blue, #13b6ec);"></i>
                                    </div>
                                    <h5 class="fw-bold mb-1" style="color: #64748b;">No hay comunicaciones</h5>
                                    <p class="mb-0">Aún no se han registrado comunicaciones internas.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content rounded-4">
                ...
                <div class="modal-body">
                    <ul class="list-group">
                        @forelse($c->documentos as $archivo)
