...
@section('title', 'Nuevo Reporte Novedad')

@section('content_header')
<div class="d-flex justify-content-between align-items-center mt-3 mb-2 px-2">
    <div>
        <h2 class="fw-bold mb-1" style="color: var(--text-main); font-size: 1.75rem;">Registrar Novedad de Nómina</h2>
        <p class="text-muted mb-0">Gestione los reportes y novedades de nómina del personal.</p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm" style="border-radius: 20px;">
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('admin.reportes-novedades-nomina.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        {{-- ESPACIO VACIO o futuro campo extra --}}
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-5">
                        ...
                        class="btn btn-light border py-3 px-4 fw-bold shadow-sm"
                        style="border-radius: 15px; font-size: 1.1rem; letter-spacing: 0.5px;">
                            <i class="fas fa-times me-2"></i> CANCELAR
                        </a>

                        <button type="submit"
                                class="btn btn-orange text-white py-3 px-4 fw-bold shadow-sm"
                                style="border-radius: 15px; font-size: 1.1rem; letter-spacing: 0.5px;">
                            <i class="fas fa-save me-2"></i> REGISTRAR NOVEDAD
                        </button>
                    </div>
