...
<div class="d-flex justify-content-between align-items-center mt-3 mb-2 px-2">
    <div>
        ...
        <p class="text-muted mb-0" style="font-size: 0.95rem;">Modifique la información del rol seleccionado.</p>
    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="estado" class="form-select">
                                    <option value="1" {{ old('estado', $role->estado ?? 1) == 1 ? 'selected' : '' }}>Activo</option>
                                    <option value="0" {{ old('estado', $role->estado ?? 1) == 0 ? 'selected' : '' }}>Inactivo</option>
                                </select>
                            </div>
